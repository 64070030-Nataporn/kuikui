      ...
      <div class="hero-body">
        <div class="columns">
          ...
          <div class="column has-text-centered">
            <img src="http://localhost:3000/uploads/bannerbook.png" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container has-background-success-light my-5">
        <div class="columns my-4">
          ...
          <div class="column has-text-centered">
            <div>
              <img
                ...
                src="http://localhost:3000/uploads/shine-stack-of-books-and-coffee-1.png"
              />
            </div>
            <router-link to="/bookchat" @click = "submit()" class="button is-light is-rounded">
          Chatroom
        </router-link>
          ...
          <div class="column is-two-quarters">
            ...
            >
              ...
              >
                ...
                <div
                  id="datebook"
                  class="date quotes has-text-black my-2"
                ></div>
          ...
          <div class="column">
            ...
            <div v-show="eventbook" v-for="ev in eventbook" class="events is-flex-direction-column" id="eventbook" :key="ev.event_id">
              <ul>
...
export default {
  ...
  mounted() {
    this.getBooks(), this.getallday(), this.onAuthChange()
  },
  methods: {
    onAuthChange() {
    ...
    addEvents() {
      axios
        ...
        .then((res) => this.$router.push({ name: "bookpage" }))
