        ...
        <div class="columns">
          <div class="column is-align-self-center">
            ...
            <p class="subtitle textsmall">
              ...
              we are when we see them.
            </p>
          </div>
          <div class="column has-text-centered">
            <img src="http://localhost:3000/uploads/Component 7.png" />
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="column has-text-centered">
          <div>
            <img
              ...
              src="http://localhost:3000/uploads/lagom-popcorn-and-3d-glasses-for-watching-movies.png"
            />
          </div>
          <router-link to="/moviechat" class="button is-light is-rounded">
          Chatroom
        </router-link>
        </div>
        <!--calendar-->
...
export default {
  ...
  mounted() {
    this.getMovs(), this.getallday(), this.onAuthChange()
  },
  methods: {
    onAuthChange() {
