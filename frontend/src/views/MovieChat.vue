        ...
        <div>
          <div class="chatting">
            <div class="user-detail">
              <img class="typeChating" src="https://media.discordapp.net/attachments/1079116062571892827/1079116777511985233/online-cinema-art-movie-watching-with-popcorn-and-film-strip-cinematograph-concept-png.png?width=663&height=663">
              <h4>Movie Chat</h4>
            </div>
  ...
  export default {
    ...
    methods: {
      submit() {
        ...
        axios
          .post("http://localhost:3000/moviechat", data)
          .then((res) => {
